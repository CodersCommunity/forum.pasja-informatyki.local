...
class Hybrid_Storage
{
	...
	public function config($key, $value=null)
	{
		...
		elseif( isset( $_SESSION["HA::CONFIG"][$key] ) ){
			return unserialize( $_SESSION["HA::CONFIG"][$key], ['allowed_classes' => false] );
		}
	...
	public function get($key)
	{
		...
		if( isset( $_SESSION["HA::STORE"], $_SESSION["HA::STORE"][$key] ) ){
			return unserialize( $_SESSION["HA::STORE"][$key], ['allowed_classes' => false] );
		}
	...
	{
		$_SESSION["HA::STORE"] = unserialize( $sessiondata, ['allowed_classes' => false] );
	}
}
