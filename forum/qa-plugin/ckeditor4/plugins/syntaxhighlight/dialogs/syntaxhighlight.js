CKEDITOR.dialog.add( 'syntaxhighlightDialog', function( editor ) {
	var getDefaultOptions=function() {
		...
		options.lang=(validLangs.indexOf(editor.config.syntaxhighlight_lang)>-1) ? editor.config.syntaxhighlight_lang : SyntaxHighlighter.defaults['code-language'].value;
